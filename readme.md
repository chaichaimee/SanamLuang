...
[![NVDA Add-on](https://img.shields.io/badge/NVDA-Add--on-blue)](https://www.nvaccess.org/)
[![ภาษาไทย](https://img.shields.io/badge/ภาษา-ไทย-brightgreen)](https://github.com/chaichaimee/SanamLuang)
...
| คำสั่ง                        | การใช้งาน                                                                 |
|-------------------------------|--------------------------------------------------------------------------|
| **NVDA+Shift+F3 (แตะสองครั้งเร็ว)** | เปิด/ปิด การแก้ไขเสียงอัตโนมัติ (Toggle On/Off)                           |
| **NVDA+Shift+F3 (แตะครั้งเดียว + มีข้อความเลือก)** | แทนที่ข้อความที่เลือกด้วยข้อความที่แก้ไขแล้ว (Replace selected text)      |
| **NVDA+Shift+F3 (แตะครั้งเดียว + ไม่มีข้อความเลือก)** | เปิดหน้าต่างตั้งค่า (Settings)                                           |
